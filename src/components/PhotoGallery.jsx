...
class PhotoGallery extends React.Component {
    ...
    handleEnd = () => {
        ...
        this.setState({
            startX: 0,
            isTouched: false,
            stoppingInterval: window.setInterval(
    ...
    render() {
        ...
        return (
            <Gallery left={this.state.left}>
                <Prev>
                    <Image
                        src={images[prev].image}
                        caption={images[prev].caption}
                    />
                </Prev>
                <div
                    ...
                    onTouchMove={(touchEvent) =>
                        this.handleMove(touchEvent.targetTouches[0].clientX)
                    }
                    onMouseMove={(mouseEvent) =>
                        this.handleMove(mouseEvent.clientX)
                    }
